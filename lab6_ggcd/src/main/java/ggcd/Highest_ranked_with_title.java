...
class ComparadorTuplos2 implements Comparator<Tuple2<String, Double>>, Serializable {
...
public class Highest_ranked_with_title {
    public static void main(String[] args) throws Exception{
        ...
        JavaPairRDD<String,String> movies = sc.sparkContext().textFile("/home/dreamerz/Desktop/GGCD/Dados/mini/title.basics.tsv.bz2")
                .map(t -> t.split("\t+"))
        ...
        sc.socketTextStream("localhost", 12345)
                ...
                .foreachRDD(rdd -> {
                    List<Tuple2<String, Double>> res = rdd
                            ...
                            .takeOrdered(3, new ComparadorTuplos2());
